<div style='display: none'>
  ...
  LastEditors: gyg
  LastEditTime: 2022-01-15 22:37:18
...
###  5.3. <a name='-1'></a>进程状态类型

####  5.3.1. <a name='STAT'></a>`STAT`  命令
...
###  6.1. <a name='kill'></a>`kill` 命令

>kill 命令用于删除执行中的程序或工作
kill 可以将指定的信号送到程序，默认信号是15，杀死， 可以杀死指定程序。

####  6.1.1. <a name='kill-1'></a>kill选项
...
用户下线
```
##  7. <a name='-1'></a>更改进程优先级

###  7.1. <a name='nice'></a>`nice` 命令
