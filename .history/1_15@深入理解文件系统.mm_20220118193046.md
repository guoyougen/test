<div style='display: none'>
  ...
  LastEditors: gyg
  LastEditTime: 2022-01-18 19:29:06
...
<!-- vscode-markdown-toc -->
* 1. [inode、文件和目录是什么](#inode)
	* 1.1. [什么是inode](#inode-1)
	* 1.2. [什么是文件](#)
	* 1.3. [什么是目录](#-1)
* 2. [如何查看文件系统和了解文件类型缩写](#-1)
	* 2.1. [文件类型:](#:)
	* 2.2. [`df` 查看已经挂载的文件系统的使用情况](#df)
	* 2.3. [`du`  查看目录大小](#du)
* 3. [文件系统到底是如何工作的](#-1)
	* 3.1. [`cp` 复制](#cp)
	* 3.2. [`mv` 移动](#mv)
...
##  1. <a name='inode'></a>inode、文件和目录是什么

###  1.1. <a name='inode-1'></a>什么是inode
...
##  2. <a name='-1'></a>如何查看文件系统和了解文件类型缩写
...
###  2.2. <a name='df'></a>`df` 查看已经挂载的文件系统的使用情况
...
##  3. <a name='-1'></a>文件系统到底是如何工作的

###  3.1. <a name='cp'></a>`cp` 复制
...
###  3.3. <a name='-1'></a>硬链接和软链接

####  3.3.1. <a name='-1'></a>硬链接
